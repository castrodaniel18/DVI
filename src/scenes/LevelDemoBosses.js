...
import WaveController, {LEVEL_1, LEVEL_DEMO_BOSS} from "../objects/Enemies/WaveController";
export default class LevelDemoBosses extends Phaser.Scene {
	constructor() {
		super({ key: 'LevelDemoBosses'});
		this.enemies = [];
		this.playerItems=[];
	...
	create() {
		...
		this.waveController = new WaveController(this, LEVEL_DEMO_BOSS);
		//Marco para nivel
